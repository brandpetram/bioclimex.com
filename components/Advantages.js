  ...
  return (
    <div>
      <div className="lg:max-w-5xl xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-full 4xl:w-10/12 mx-auto">
        ...
        <div className="mt-10 md:mt-20 xl:mt-16 3xl:mt-20 5xl:mt-32 absolute ml-20 lg:ml-24 xl:ml-20">
          <h3 className="text-gray-100 text-md uppercase font-extrabold">
            Bioclimex México
          </h3>
          <h2 className="mt-5 lg:mt-8 xl:mt-12 3xl:mt-20 lg:mt-0 text-gray-100 text-4xl md:text-11xl xl:text-17xl 2xl:text-18xl 3xl:text-22xl 4xl:text-25xl 5xl:text-29xl max-w-xs w-2/3 md:max-w-xl 3xl:max-w-4xl font-medium md:font-bold leading-none">
