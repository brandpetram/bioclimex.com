                      ...
                      <div className="mt-6 relative flex-1 px-4 sm:px-6">
                        ...
                        <div className="absolute inset-0 px-4 sm:px-6">
                          <div className="h-full" aria-hidden="true">
                            <nav className="grid gap-y-5 text-gray-600 text-lg pt-6">
                              ...
                              <a
                                  className="grid gap-y-5 text-gray-600 text-lg "
                            ...
                            <div className="w-full h-2 border-t border-dashed border-gray-800 mt-8"></div>
                            <div className="pt-4  h-[30vh] text-gray-600">
                              <h1 className="font-bold text-xl">Llámanos</h1>
                              <div className="mt-4 font-extralight text-lg space-y-3 flex flex-col">
                                <a href="tel:(55) 5919 7533"> (55) 5919 7533</a>
                              </div>
                              <a
                                  target="_blank"
